...
public class PhotoEditorView extends RelativeLayout {
    ...
    public void fitVertical() {
        RelativeLayout.LayoutParams imgSrcParam = (LayoutParams) mImgSource.getLayoutParams();
        imgSrcParam.width = ViewGroup.LayoutParams.WRAP_CONTENT;
        imgSrcParam.height = ViewGroup.LayoutParams.MATCH_PARENT;
        mImgSource.requestLayout();

        RelativeLayout.LayoutParams brushParam = (LayoutParams) mBrushDrawingView.getLayoutParams();
        brushParam.width = ViewGroup.LayoutParams.WRAP_CONTENT;
        brushParam.height = ViewGroup.LayoutParams.MATCH_PARENT;
        mBrushDrawingView.requestLayout();

        RelativeLayout.LayoutParams imgFilterParam = (LayoutParams) mImageFilterView.getLayoutParams();
        imgFilterParam.width = ViewGroup.LayoutParams.WRAP_CONTENT;
        imgFilterParam.height = ViewGroup.LayoutParams.MATCH_PARENT;
        mImageFilterView.requestLayout();

    }
    public void fitHorizontal() {
        RelativeLayout.LayoutParams imgSrcParam = (LayoutParams) mImgSource.getLayoutParams();
        imgSrcParam.width = ViewGroup.LayoutParams.MATCH_PARENT;
        imgSrcParam.height = ViewGroup.LayoutParams.WRAP_CONTENT;
        mImgSource.requestLayout();

        RelativeLayout.LayoutParams brushParam = (LayoutParams) mBrushDrawingView.getLayoutParams();
        brushParam.width = ViewGroup.LayoutParams.MATCH_PARENT;
        brushParam.height = ViewGroup.LayoutParams.WRAP_CONTENT;
        mBrushDrawingView.requestLayout();

        RelativeLayout.LayoutParams imgFilterParam = (LayoutParams) mImageFilterView.getLayoutParams();
        imgFilterParam.width = ViewGroup.LayoutParams.MATCH_PARENT;
        imgFilterParam.height = ViewGroup.LayoutParams.WRAP_CONTENT;
        mImageFilterView.requestLayout();
    }
}
